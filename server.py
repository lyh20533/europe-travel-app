...
def seed_db(conn):
    ...
    schedules = [
        ...
        ("2026-09-24", "09/24 (목)", 9, 24, "목", "부다페스트 ➔ 트레비소 ➔ 코르티나", "🛫 부다페스트 ➔ 트레비소 & 🚗 렌트카 픽업 후 브라이에스 호수", "라이언에어 FR4305 (11:10~12:35)\n13:30 렌터카 수령 후 브라이에스 호수 탐방", "Best Western Hotel Nevada (1박/총2박)", '["flight", "car", "hotel"]', "theme-flight", "라이언에어 FR4305 / 렌터카 IT588376222", "13:30 렌터카 픽업 후 16:00 브라이에스 호수 도착.", 46.6947, 12.0854, '[{"name":"1. 🛬 트레비소 공항 & 🚗 Sicily By Car","lat":45.6484,"lng":12.1944,"desc":"12:35 도착 & 13:30 렌터카 인수"},{"name":"2. 🌊 브라이에스 호수 (Lago di Braies)","lat":46.6947,"lng":12.0854,"desc":"에메랄드빛 산정 호수 탐방"},{"name":"3. 🏨 Best Western Hotel Nevada","lat":46.4636,"lng":12.1583,"desc":"코르티나 담페초 체크인"}]'),
        ("2026-09-25", "09/25 (금)", 9, 25, "금", "돌로미티 동부 (코르티나 담페초)", "⛰️ 트레치메 라바레도 트레킹 & 미수리나 호수", "트레치메 순환 트레킹 및 미수리나 호수 조망", "Best Western Hotel Nevada (2박/총2박)", '["car", "hotel"]', "theme-dolomites", "주차티켓 P26230761", "06:30 아우론조 산장 주차장 입장.", 46.6186, 12.3017, '[{"name":"1. 🏨 Best Western Hotel Nevada","lat":46.4636,"lng":12.1583,"desc":"06:00 출발"},{"name":"2. ⛰️ 트레치메 라바레도 (아우론조 산장)","lat":46.6186,"lng":12.3017,"desc":"06:30 예약 주차장 입장 & 순환 트레킹"},{"name":"3. 🌊 미수리나 호수 (Lago di Misurina)","lat":46.5828,"lng":12.2544,"desc":"에메랄드 산정 호수 조망"},{"name":"4. 🏨 Best Western Hotel Nevada","lat":46.4636,"lng":12.1583,"desc":"숙소 복귀"}]'),
        ("2026-09-26", "09/26 (토)", 9, 26, "토", "코르티나 담페초 ➔ 발 가르데나", "⛰️ 친퀘토리 & 라가주오이 탐방 및 서부 이동", "친퀘토리, 라가주오이 (패스 사용) 탐방 후 서부 이동하여 산타막달레나 일몰 감상", "Hotel Eda (1박/총3박)", '["hotel", "car"]', "theme-dolomites", "Hotel Eda (5658.440.161 / PIN 3285)", "돌로미티 서부 이동 및 일몰 감상.", 46.5277, 12.0083, '[{"name":"1. 🏨 Best Western Hotel Nevada","lat":46.4636,"lng":12.1583,"desc":"체크아웃 후 출발"},{"name":"2. ⛰️ 친퀘토리 (Cinque Torri)","lat":46.5076,"lng":12.0543,"desc":"거대한 5개의 암봉 탐방"},{"name":"3. ⛰️ 라가주오이 (Rifugio Lagazuoi)","lat":46.5277,"lng":12.0083,"desc":"케이블카 패스 탑승 후 전경 조망"},{"name":"4. 🌅 산타막달레나 (Santa Maddalena)","lat":46.6385,"lng":11.7236,"desc":"일몰 뷰포인트 감상"},{"name":"5. 🏨 Hotel Eda (발 가르데나 셀바)","lat":46.5556,"lng":11.7584,"desc":"돌로미티 서부 3박 체크인"}]'),
        ("2026-09-27", "09/27 (일)", 9, 27, "일", "돌로미티 서부 (발 가르데나)", "🏔️ 세체다 & 알페 디 시우시 & 카레짜 호수", "세체다 절벽, 알페 디 시우시 고원 산책 후 카레짜 호수 방문", "Hotel Eda (2박/총3박)", '["hotel", "car"]', "theme-dolomites", "Hotel Eda (5658.440.161)", "세체다 오전 탑승, 오후 알페 디 시우시 및 카레짜 호수.", 46.5756, 11.6742, '[{"name":"1. 🏨 Hotel Eda","lat":46.5556,"lng":11.7584,"desc":"08:30 출발"},{"name":"2. 🏔️ 세체다 (Seceda)","lat":46.5756,"lng":11.6742,"desc":"오르티세이 케이블카 탑승 & 절벽 조망"},{"name":"3. 🌲 알페 디 시우시 (Alpe di Siusi)","lat":46.5700,"lng":11.6700,"desc":"유럽 최대 고원 산책"},{"name":"4. 🌊 카레짜 호수 (Lago di Carezza)","lat":46.4093,"lng":11.5815,"desc":"무지개 호수 산책"},{"name":"5. 🏨 Hotel Eda","lat":46.5556,"lng":11.7584,"desc":"숙소 복귀"}]'),
        ("2026-09-28", "09/28 (월)", 9, 28, "월", "돌로미티 서부 (발 가르데나)", "🏔️ 사쏘룽고 & 파쏘 포르도이 & QC 테르메 온천", "사쏘룽고 주변 패스 드라이빙 및 파쏘 포르도이 경유 후 QC 테르메에서 온천 휴식", "Hotel Eda (3박/총3박)", '["hotel", "car"]', "theme-dolomites", "Hotel Eda (5658.440.161)", "오전 산악 드라이빙, 오후 온천 힐링.", 46.4883, 11.8105, '[{"name":"1. 🏨 Hotel Eda","lat":46.5556,"lng":11.7584,"desc":"09:00 출발"},{"name":"2. 🏔️ 사쏘룽고 (Sassolungo)","lat":46.5186,"lng":11.7377,"desc":"웅장한 사쏘룽고 조망"},{"name":"3. 🏔️ 파쏘 포르도이 (Passo Pordoi)","lat":46.4883,"lng":11.8105,"desc":"고산 패스 드라이빙"},{"name":"4. ♨️ QC Terme Dolomiti","lat":46.4357,"lng":11.6853,"desc":"돌로미티 럭셔리 온천 힐링"},{"name":"5. 🏨 Hotel Eda","lat":46.5556,"lng":11.7584,"desc":"숙소 복귀"}]'),
        ("2026-09-29", "09/29 (화)", 9, 29, "화", "트레비소 ➔ 베네치아 메스트레", "🌊 카레짜 호수 & 🚗 렌터카 반납 후 베네치아 이동", "아침 카레짜 호수 들른 후 트레비소 공항으로 이동하여 렌터카 반납 및 베네치아 이동", "Anda Venice Hostel (1박/총2박)", '["pending", "hotel"]', "theme-venice", "Anda Venice (5380.194.531)", "트레비소 공항 반납 후 베네치아 본섬으로.", 45.6484, 12.1944, '[{"name":"1. 🏨 Hotel Eda","lat":46.5556,"lng":11.7584,"desc":"체크아웃"},{"name":"2. 🌊 카레짜 호수 (Lago di Carezza)","lat":46.4093,"lng":11.5815,"desc":"아침 호수 산책"},{"name":"3. 🚗 트레비소 공항 렌터카 반납","lat":45.6484,"lng":12.1944,"desc":"렌터카 반납 후 베네치아 버스 탑승"},{"name":"4. 🏨 Anda Venice Hostel (메스트레)","lat":45.4842,"lng":12.2359,"desc":"베네치아 숙소 체크인"}]'),
